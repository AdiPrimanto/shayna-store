                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/shoppingcart"><a href="#" class="primary-btn pd-cart">Add To Cart</a></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/product-single/product-1.jpg",
      thumbs: [
        "img/product-single/product-1.jpg",
        "img/product-single/product-2.jpg",
        "img/product-single/product-3.jpg",
        "img/product-single/tab-desc.jpg"
      ]
    }
  },
  methods: {
